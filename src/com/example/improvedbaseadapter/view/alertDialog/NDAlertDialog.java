 ...
 */
public class NDAlertDialog extends AlertDialog implements DialogInterface {
    private NDAlertController mAlert;

    protected NDAlertDialog(Context context) {
        this(context, R.style.CustomAlertDialog);
    }

    protected NDAlertDialog(Context context, int theme) {
        super(context, theme);
        mAlert = new NDAlertController(context, this, getWindow());
    }

    protected NDAlertDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public static class Builder extends AlertDialog.Builder {
        private final NDAlertController.AlertParams P;

        /**
         * Constructor using a context for this builder and the
         * {@link NDAlertDialog} it creates.
         */
        public Builder(Context context) {
            super(context);
            P = new NDAlertController.AlertParams(context);
        }
        ...
        /**
         * set the dialog will or not dismiss after the button clicked
         * 
         * @return This Builder object to allow for chaining of calls to set
         *         methods
         */
        public Builder setAutoDismiss(boolean mAutoDismiss) {
            P.mAutoDismiss = mAutoDismiss;
            return this;
        }
        ...
        /**
         * Creates a {@link NDAlertDialog} with the arguments supplied to this
        ...
        public AlertDialog create() {
            final NDAlertDialog dialog = new NDAlertDialog(P.mContext);
            P.apply(dialog.mAlert);
            dialog.setCancelable(P.mCancelable);
            dialog.setCanceledOnTouchOutside(P.canceledOnTouchOutside);
