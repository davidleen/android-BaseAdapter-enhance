...
package com.example.improvedbaseadapter.view.alertDialog;
...
public class NDAlertController {
    ...
    public static int m_MyAlertContentViewId = R.layout.custom_alertdialog; // 默认的对话框布局ID
    ...
    public NDAlertController(Context context, DialogInterface di, Window window) {
        mContext = context;
        mDialogInterface = di;
        mWindow = window;
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        int fullDark = color;
        int topDark = color;
        int centerDark = color;
        int bottomDark = color;
        int fullBright = color;
        int topBright = color;
        int centerBright = color;
        int bottomBright = color;
        int bottomMedium = color;
    ...
    public static class AlertParams {
        ...
        public void apply(NDAlertController dialog) {
            if (mCustomTitleView != null) {
            ...
            dialog.mAutoDismiss = mAutoDismiss;
        ...
        private void createListView(final NDAlertController dialog) {
            final RecycleListView listView = (RecycleListView)
                    mInflater.inflate(R.layout.custom_alertdialog_select, null);
            ListAdapter adapter;

            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                            mContext, R.layout.custom_alertdialog_select_multichoice,
                    ...
                    adapter = new CursorAdapter(mContext, mCursor, false) {
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup parent) {
                            return mInflater.inflate(
                                    R.layout.custom_alertdialog_select_multichoice,
                                    parent, false);
                        }
                ...
                int layout = mIsSingleChoice
                        ? R.layout.custom_alertdialog_select_singlechoice
                        : R.layout.custom_alertdialog_select_item;
                if (mCursor == null) {
                    adapter = (mAdapter != null) ? mAdapter
                            : new ArrayAdapter<CharSequence>(mContext, layout, android.R.id.text1,
                                    mItems);
                } else {
